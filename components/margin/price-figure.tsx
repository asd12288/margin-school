 ...
 * *invented* one because a real chart on a marketing screen would be read as a
 * market claim. The path is a fixed literal rather than generated: a seeded
 * generator would be machinery for a variation nobody asked for, and the same
 * figure appearing on the auth panel and the home hero is a brand mark rather
 * than a repetition to hide.
 *
 ...
 *
 * `id` is a prop because two of these can share a page — the home hero and a
 * course aside — and duplicate gradient ids in one document make the second
 * figure reference the first one's stops.
 */
