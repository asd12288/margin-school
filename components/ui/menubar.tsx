  ...
  return (
    <MenubarPortal>
      <MenubarPrimitive.Content
        ...
        className={cn("z-50 min-w-36 origin-(--radix-menubar-content-transform-origin) overflow-hidden rounded-lg bg-popover p-1 text-popover-foreground shadow-md ring-1 ring-foreground/10 data-open:animate-menu-in", className )}
        {...props}
      />
    </MenubarPortal>
  )
...
function MenubarSubContent({
  ...
  return (
    <MenubarPrimitive.SubContent
      ...
      className={cn("z-50 min-w-32 origin-(--radix-menubar-content-transform-origin) overflow-hidden rounded-lg bg-popover p-1 text-popover-foreground shadow-lg ring-1 ring-foreground/10 data-open:animate-menu-in data-closed:animate-menu-out", className )}
      {...props}
    />
  )
}
